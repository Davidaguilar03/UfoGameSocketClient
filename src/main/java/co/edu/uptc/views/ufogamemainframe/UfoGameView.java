...
public class UfoGameView extends JFrame implements UfoGameInterface.View {
    ...
    public void updateConnectedPlayers(int connectedPlayers) {
        ufoGameBody.getUfoGamePlayView().getUfoGamePlayHeader().incrementConnectedPlayers(connectedPlayers);
    }
    ...
    public void updatePlayersList() {
        if (ufoGameBody.getUfoGamePlayView() != null) {
            ufoGameBody.getUfoGamePlayView().getUfoGamePlayHeader().updatePlayersList(); 
        }
    }
}
